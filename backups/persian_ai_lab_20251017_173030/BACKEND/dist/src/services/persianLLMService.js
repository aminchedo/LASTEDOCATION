...
exports.PersianLLMService = void 0;
const logger_1 = require("../middleware/logger");
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
class PersianLLMService {
    constructor() {
        this.datasetPath = path_1.default.join(process.cwd(), 'datasets', 'combined.jsonl');
        this.responses = new Map();
        this.loadResponses();
    }
    loadResponses() {
        try {
            if (fs_1.default.existsSync(this.datasetPath)) {
                const data = fs_1.default.readFileSync(this.datasetPath, 'utf-8');
                ...
                logger_1.logger.warn({ msg: 'dataset_not_found', path: this.datasetPath });
            }
        }
        catch (error) {
            logger_1.logger.error({ msg: 'failed_to_load_responses', error: error.message });
        }
    }
    normalizeText(text) {
        return text
    ...
    async generateResponse(messages, _options) {
        ...
        try {
            ...
            logger_1.logger.debug({ msg: 'persian_system_prompt_enforced', prompt: systemPrompt });
...
exports.PersianLLMService = PersianLLMService;
//# sourceMappingURL=persianLLMService.js.map