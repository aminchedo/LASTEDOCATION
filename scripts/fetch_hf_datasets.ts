...
const HF_DATASETS: HuggingFaceDataset[] = [
  {
...
function convertSentimentToConversation(data: any[]): ConversationData[] {
...
function convertGeneralToConversation(data: any[]): ConversationData[] {
  return data.map(item => ({
    messages: [
...
function convertNewsToConversation(data: any[]): ConversationData[] {
  return data.map(item => ({
    messages: [
...
async function fetchHuggingFaceDatasets(): Promise<ConversationData[]> {
...
function prepareDatasets(conversations: ConversationData[]): void {
...
export { fetchHuggingFaceDatasets, HF_DATASETS };
