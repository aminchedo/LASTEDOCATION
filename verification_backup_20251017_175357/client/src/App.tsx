...
const AILabSettingsPage = lazy(() => import('@/pages/AILab/SettingsPage').then(module => ({ default: module.AILabSettingsPage })));
                ...
                <LazyLoadErrorBoundary>
                  <Suspense fallback={<PageLoader />}>
                    <Routes>
                      ...
                      <Route path="/ai-lab/settings" element={<AILabSettingsPage />} />
